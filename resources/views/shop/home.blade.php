...
<body data-bs-spy="scroll" data-bs-target="#navScroll">
    ...
    <nav id="navScroll" class="navbar navbar-expand-lg navbar-light fixed-top" tabindex="0">
        <div class="container">
            <a class="navbar-brand pe-4 fs-4" href="/">
                ...
                <span class="ms-1 fw-bolder">Muebles Import</span>
            </a>
            ...
            <div class="container position-relative">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 py-vh-6 position-relative" data-aos="fade-right">
                        <h1 class="display-1 fw-bold mt-5">¡Acá encontraras todo lo que necesitas!</h1>
                        <p class="lead">A solo un par de click podras obtener todo lo que deseas</p>
                    </div>
            ...
            <div class="container">
                <div class="row d-flex justify-content-end">
                    <div class="col-lg-8" data-aos="fade-down">
                        <h2 class="display-6">El consumidor compra un producto para ganar en «prestigio» de cara a los
                            demás. En línea con la anterior razón, el consumidor busca exclusividad a través de calidad
                            y aca es el lugar perfecto donde la encontraras.</h2>
                    </div>
                </div>
                <div class="row d-flex align-items-center">
                    <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <span class="h5 fw-lighter">01.</span>
                        <h3 class="py-5 border-top border-dark">Recibir tus compras a domicilio</h3>
                        <p>A tu disposicion sin mucho esfuerzo.</p>
                    </div>

                    <div class="col-md-6 col-lg-4 py-vh-4 pb-0" data-aos="fade-up" data-aos-delay="400">
                        <span class="h5 fw-lighter">02.</span>
                        <h3 class="py-5 border-top border-dark">Calidad en productos.</h3>
                        <p>Encontraras productos que no estan disponibles en tiendas fisicas.</p>
                    </div>

                    <div class="col-md-6 col-lg-4 py-vh-6 pb-0" data-aos="fade-up" data-aos-delay="600">
                        <span class="h5 fw-lighter">03.</span>
                        <h3 class="py-5 border-top border-dark">Operacion de compra.</h3>
                        <p>Puedes realizar tu compra con nuestro soporte de ventas desde donde te encuentres.</p>
                    </div>
                </div>
                        ...
                        <div class="row gx-5 d-flex">
                            <div class="col-md-11">
                                <div class="shadow ratio ratio-16x9 rounded bg-cover bp-center align-self-end"
                                    data-aos="fade-right"
                                    style="background-image: url(img/webp/Muebles-Slide.webp);--bs-aspect-ratio: 50%;">
                                </div>
                            </div>
                            <div class="col-md-5 offset-md-1">
                                <div class="shadow ratio ratio-1x1 rounded bg-cover mt-5 bp-center float-end"
                                    data-aos="fade-up" style="background-image: url(img/interior37.jpg);">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="col-12 shadow ratio rounded bg-cover mt-5 bp-center" data-aos="fade-left"
                                    style="background-image: url(img/interior29.jpg);--bs-aspect-ratio: 150%;">
                                </div>
                            </div>
    ...
    <!-- feature_part start-->
    <section class="feature_part padding_top" id="aboutus">
        <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8 text-center" data-aos="fade">
                            <p class="text-secondary lead">¡Hazlo ya!</p>
                    ...
                    <div class="col-md-6 col-lg-4 border-end" data-aos="fade-up">
                        <div class="d-flex">
                            ...
                            <div class="col-md-9 flex-fill">
                                ...
                                <p>Si tuviéramos bienes físicos, los enviaríamos a la puerta de su casa. por supuesto en
                                    tiempo y a la dirección correcta. Pero no tenemos productos reales...</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 border-end" data-aos="fade-up" data-aos-delay="200">
                        <div class="d-flex">
                            ...
                            <div class="col-md-9 flex-fill">
                                ...
                                <p>Tal vez haríamos algo para asegurarnos de que recibas lo que pediste. pero no puedes
                                    ordene cualquier cosa aquí, para que podamos darle una garantía del 100% de que cualquier cosa sería
                                    ¡estupendo!</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                        <div class="d-flex">
                            ...
                            <div class="col-md-9 flex-fill">
                                ...
                                <p>Bien, tenemos este loco formulario de soporte en línea. Complétalo y el contenido será
                                    enviado por correo en formato PDF. Imprimirlo. Luego envíelo por fax a nuestro super duper hidden
                                    Número de fax.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row py-5 d-flex justify-content-between">
                ...
                <div class="col-12 col-lg-6 col-xl-3 border-end p-5">
                    ...
                    <address class="text-secondary mt-3">
                        ...
                        (123) 456-7890 {{-- cambiar dinamicamente en una variable
                            o si se complica quitarla --}}
                    </address>
                </div>
                <div class="col-12 col-lg-6 col-xl-3 border-end p-5">
...
{{--                             <a class="nav-link link-secondary ps-0" aria-current="page" href="/login" style="font-size: 25px!important">
                ...
                <div class="col-12 col-lg-6 col-xl-3 p-5">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link link-secondary ps-0" aria-current="page" href="#">404 System
                                Page</a>
                            <a class="nav-link link-secondary ps-0" aria-current="page" href="#">Register
                                System Page</a>
                            <a class="nav-link link-secondary ps-0" aria-current="page" href="#">Simple
                                Text Content Page</a>
                        </li>
                    </ul>
                </div>
